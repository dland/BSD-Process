...

{
    ...
    is($pe->utime_ch,    delete $pe->{utime_ch},    'method utime');
    is($pe->stime_ch,    delete $pe->{stime_ch},    'method stime');
    is($pe->maxrss_ch,   delete $pe->{maxrss_ch},   'method maxrss');
    is($pe->ixrss_ch,    delete $pe->{ixrss_ch},    'method ixrss');
    is($pe->idrss_ch,    delete $pe->{idrss_ch},    'method idrss');
    is($pe->isrss_ch,    delete $pe->{isrss_ch},    'method isrss');
    is($pe->minflt_ch,   delete $pe->{minflt_ch},   'method minflt');
    is($pe->majflt_ch,   delete $pe->{majflt_ch},   'method majflt');
    is($pe->nswap_ch,    delete $pe->{nswap_ch},    'method nswap');
    is($pe->inblock_ch,  delete $pe->{inblock_ch},  'method inblock');
    is($pe->oublock_ch,  delete $pe->{oublock_ch},  'method oublock');
    is($pe->msgsnd_ch,   delete $pe->{msgsnd_ch},   'method msgsnd');
    is($pe->msgrcv_ch,   delete $pe->{msgrcv_ch},   'method msgrcv');
